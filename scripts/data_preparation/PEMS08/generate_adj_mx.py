        ...
        if id_filename:
            ...
            with open(distance_df_filename, "r") as f:
                ...
                for row in reader:
                    ...
                    adjacency_matrix_distance[id_dict[j], id_dict[i]] = distance
...
def generate_adj_pems08(directed=False):
    ...
    if directed:
        adj_mx, distance_mx = get_directed_adjacency_matrix(distance_df_filename, num_of_vertices, id_filename=id_filename)
    else:
